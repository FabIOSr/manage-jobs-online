        ...
        <div class="col-md-10">
            ...
            <div class="row mb-2 border-bottom pb-3">
                ...
                <div class="col-md-3 text-end">
                    <a href="{{ route('experiences.create') }}" class="btn btn-sm btn-secondary">Inserir nova experiência +</a>
                </div>
            </div>
                ...
                <table class="table table-sm">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $item->status }}</td>
                        <td>
                            <a href="{{ route('experiences.edit', $item->code) }}"
                            ...
                            <form id="delete-{{ $item->code }}" action="{{ route('experiences.delete', $item->code) }}" method="POST" class="d-none">@csrf</form>
                            <button type="button"
