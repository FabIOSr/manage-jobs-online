            ...
            <div class="col-md-10">
                ...
                <div class="row border-bottom mb-2 pb-2 mx-1">
                    ...
                    <div class="col-md-3 text-end pe-0">
                        <a href="{{ route('experiences') }}" autocomplete="off" class="btn btn-sm btn-secondary"> Voltar para Lista</a>
                    </div>
                </div>
        
                <div class="row justify-content-start g-3">
                    <div class="col-md-8 ps-3">
                        <form action="{{ route('experiences.update', $experience->id) }}" method="POST" autocomplete="off">
                            @csrf
                            <div class="row g-2">                                
                                <div class="col-md-9">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="status" class="form-select form-select-sm">
                                      ...
                                      <option value="ACTIVE" @if(old('status', $experience->status) == 'ACTIVE') selected @endif>ATIVO</option>
                                      <option value="INACTIVE" @if(old('status', $experience->status) == 'INACTIVE') selected @endif>INATIVO</option>
                                    </select>
                                  </div>
                                <div class="col-12">
