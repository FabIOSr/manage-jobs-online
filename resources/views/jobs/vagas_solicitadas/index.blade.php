        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold poppins"
                    id="exampleModalLabel">Detalhes vaga solicitada
                </h5>
            ...
            <div class="modal-body">
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td class="">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aliquid eligendi aperiam eveniet earum nihil? Nam aliquid tempora pariatur, commodi obcaecati quos natus exercitationem facere quis?</td>
                    </tr>
                </table>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-secondary"
                    data-bs-dismiss="modal">Aprovar Direto</button>
